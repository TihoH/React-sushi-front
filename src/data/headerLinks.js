export const headerLinks = [
  { link: "Сети", id: 1, category: "sets", description: "Гарячі та холодні сети ролів для компанії або на вечерю." },
  { link: "Роли та суші", id: 2, category: "rols", description: "Світові класичні та авторські роли та суші на будь-який смак." },
  { link: "Акції", id: 3, category: "stock", description: "Вигідні пропозиції та спеціальні знижки на популярні страви." },
  { link: "1+1=3", id: 4 , category: 'plusSushi', description: "Спеціальна акція: замовляйте більше та отримуйте бонуси." },
